...
final class BaseStringHashValueRedisRepositoryTests extends RedisTestContainer {
    ...
    static void beforeAll() {
        ...
        repository = new BaseStringHashValueRedisRepository<>(RedisRepositoryConfiguration.builder()
                .jedisPool(jedisPool)
    ...
    void testGetMultiple() {
        ...
        expectedPeopleMap.values().forEach(BaseStringHashValueRedisRepositoryTests::insert);
