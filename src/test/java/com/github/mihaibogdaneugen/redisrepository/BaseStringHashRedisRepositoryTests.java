...
final class BaseStringHashRedisRepositoryTests extends RedisTestContainer {
    ...
    static void beforeAll() {
        ...
        repository = new BaseStringHashRedisRepository<>(RedisRepositoryConfiguration.builder()
                .jedisPool(jedisPool)
    ...
    void testGetMultiple() {
        ...
        expectedPeopleMap.values().forEach(BaseStringHashRedisRepositoryTests::insert);
