...
final class EachEntityIsAValueInAHashRedisRepositoryTests extends RedisTestContainer {

    static final Logger logger = LoggerFactory.getLogger(EachEntityIsAValueInAHashRedisRepositoryTests.class);
    ...
    class TestsForGetMultiple {
        ...
        void testGetMultiple() {
            ...
            expectedPeopleMap.values().forEach(EachEntityIsAValueInAHashRedisRepositoryTests::insert);
    ...
    class TestsForGetAllIds {
        ...
        void testGetAllIds() {
            ...
            jedis.hdel("people", allIds.toArray(String[]::new));
