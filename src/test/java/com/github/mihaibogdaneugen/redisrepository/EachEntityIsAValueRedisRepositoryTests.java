...
final class EachEntityIsAValueRedisRepositoryTests extends RedisTestContainer {

    static final Logger logger = LoggerFactory.getLogger(EachEntityIsAValueRedisRepositoryTests.class);
    static final ObjectMapper objectMapper = new ObjectMapper()
            .registerModule(new JavaTimeModule())
            .disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
    static final Function<Person, String> serializer = person -> {
        try {
    ...
    static final Function<String, Person> deserializer = entity -> {
        try {
    ...
    static void beforeAll() {
        ...
        final var configuration = RedisRepositoryConfiguration.<Person>builder()
                ...
                .eachEntityIsAValue(serializer, deserializer)
                .build();
    ...
    class TestsForGetMultiple {
        ...
        void testGetMultiple() {
            ...
            expectedPeopleMap.values().forEach(EachEntityIsAValueRedisRepositoryTests::insert);
    ...
    private static void insert(final Person person) {
        jedis.set("people:" + person.getId(), serializer.apply(person));
    }

    private static Optional<Person> get(final String id) {
        final var entity = jedis.get("people:" + id);
        return entity == null || entity.isEmpty() || entity.isBlank() ? Optional.empty() : Optional.of(deserializer.apply(entity));
    }
