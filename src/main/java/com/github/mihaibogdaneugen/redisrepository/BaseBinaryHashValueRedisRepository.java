...
public abstract class BaseBinaryHashValueRedisRepository<T>
    ...
    /**
     * Builds a BaseBinaryHashValueRedisRepository based on a configuration object.
     * @param configuration RedisRepositoryConfiguration object
     */
    public BaseBinaryHashValueRedisRepository(final RedisRepositoryConfiguration configuration) {
