 ...
 * binary values and stored as key-maps pairs (Redis hashes) <br/>
 * Design details:<br/>
...
public abstract class BinaryHashRedisRepository<T> extends BaseRedisRepository<T> {
    ...
    /**
     * Builds a BinaryHashRedisRepository, based around a Jedis object, for a specific collection.<br/>
    ...
    /**
     * Builds a BinaryHashRedisRepository, based around a jedisPool object, for a specific collection.<br/>
     ...
     * @see <a href="https://redis.io/commands/HSET">HSET</a>
     * @param id The String identifier of the entity
     * @param fieldAndValue A Map.Entry pair of a field and value, serialized as byte[] objects
     */
