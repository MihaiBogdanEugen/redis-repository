...
public abstract class StringHashRedisRepository<T> extends BaseRedisRepository<T> {
    ...
    /**
     * Builds a StringHashRedisRepository, based around a Jedis object, for a specific collection.<br/>
    ...
    /**
     * Builds a StringHashRedisRepository, based around a jedisPool object, for a specific collection.<br/>
