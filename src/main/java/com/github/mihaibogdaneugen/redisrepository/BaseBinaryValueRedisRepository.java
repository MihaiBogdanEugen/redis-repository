...
public abstract class BaseBinaryValueRedisRepository<T>
    ...
    /**
     * Builds a BaseBinaryValueRedisRepository, based around a Jedis object, for a specific collection.<br/>
     ...
     */
    public BaseBinaryValueRedisRepository(final Jedis jedis, final String collectionKey) {
        super(jedis);
    ...
    /**
     * Builds a BaseBinaryValueRedisRepository, based around a jedisPool object, for a specific collection.<br/>
